...
// mvsToSlpkUI.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CmvsToSlpkUIApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CmvsToSlpkUIApp construction

CmvsToSlpkUIApp::CmvsToSlpkUIApp()
{
